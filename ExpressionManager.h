...
public:
    ...
    Block* makeBlock(Decls* decls, Stmts* stmts){
        Block* o = new Block(decls, stmts);
        allocated.push_back(o);
        return o;
    }
    ...
    boolConstant* makeBoolConstant(int value) {
    ...
    Stmts* makeStmts(Stmts* stmts, Stmt* stmt)
    {
        Stmts* o = new Stmts(stmts,stmt);
        allocated.push_back(o);
        return o;        
    }
